...
Uses TeeLisB, TeeConst, Series, TeCanvas, TeePenDlg;
...
Function GetChartGalleryClass( AOwner:TComponent;
                               ...
                               CheckValidSeries:Boolean;
                               Var SubIndex:Integer):Boolean;
Const TeeBorderSizeable={$IFDEF CLX}fbsSizeable{$ELSE}bsSizeable{$ENDIF};
begin
  result:=False;
  ...
  try
    ...
    begin
      ...
      if result then Show3D:=CB3D.Checked and ChartGalleryPanel1.SelectedChart.View3D;
    end;
  finally
    Free;
  end;
