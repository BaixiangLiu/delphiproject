...
begin
  ...
  TeeMsg_EnterDateTime      :='输入 [总天数] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='*.tee 档案的图表不正确';
  TeeMsg_WrongTeeFileFormat :='*.tee 档案格式错误';
  TeeMsg_EmptyTeeFile       :='空白的 *.tee 档案';  { 5.01 }
...
'SIDE BRUSH=侧面笔刷'#13+
'ABOUT TEECHART PRO V6.01=有关 TeeChart Pro v6.01'#13+
