...
begin
  { TeeConst }
  TeeMsg_Copyright          :='© 1995-2003 Давід Бернеда';
  ...
  TeeMsg_InvalidTeeFile     :='Неправильний графік у *.tee файлі';
  TeeMsg_WrongTeeFileFormat :='Неправильний формат *.tee файлу';
  TeeMsg_EmptyTeeFile       :='Порожній *.tee файл';  { 5.01 }
...
'ABOUT TEECHART PRO V6.01=О TeeChart Pro v6.01'#13+
