...
begin
  ...
  TeeMsg_EnterDateTime      :='Anna [päivien lukumäärä] [hh:mm:ss]';
...
//  TeeMsg_AxisDlgValue       :='Arvo:';
  ...
  TeeMsg_InvalidTeeFile     :='Epäkelpo kaavio *.tee tiedostossa';
  TeeMsg_WrongTeeFileFormat :='Väärä *.tee tiedostomuoto';
  TeeMsg_EmptyTeeFile       :='Tyhjä *.tee tiedosto';  { 5.01 }
  ...
  TeeMsg_NativeFilter :='TeeChart-tiedostot (*.tee)|*.tee';
...
'CLOSE=Sulje'+#13+
'OK=OK'+#13+
'ABOUT TEECHART PRO V6.01=TeeChart Pro v6.01 ohjelmasta'+#13+
...
'HORIZ. SIZE=Vaakasuunnan koko'+#13+
'VERT. SIZE=Pystysuunnan koko'+#13+
'SHAPES=Muodot'+#13+
