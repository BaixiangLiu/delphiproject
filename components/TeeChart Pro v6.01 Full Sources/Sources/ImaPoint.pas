...
begin
  ...
  begin
    ...
    With ParentChart.Canvas do
         StretchDraw(CalcRect3D(R,StartZ),FImagePoint.Graphic);
  end;
end;
...
begin
  ...
  begin
    ChangeHorizSize(FImagePoint.Width);
    ChangeVertSize(FImagePoint.Height);
  end;
end;
...
initialization
  RegisterTeeSeries( TImagePointSeries, @TeeMsg_ImagePointSeries, @TeeMsg_GallerySamples, 1 );
  RegisterTeeSeries( TDeltaPointSeries, @TeeMsg_DeltaPointSeries, @TeeMsg_GallerySamples, 1 );
finalization
