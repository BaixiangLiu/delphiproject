...
begin
  ...
  begin
    ...
    begin
      TeeInsertPointerForm(Parent,Box.Pointer,TeeMsg_Box);
      TeeInsertPointerForm(Parent,Box.ExtrOut,TeeMsg_ExtrOut);
      TeeInsertPointerForm(Parent,Box.MildOut,TeeMsg_MildOut);
    end;
  end;
end;
