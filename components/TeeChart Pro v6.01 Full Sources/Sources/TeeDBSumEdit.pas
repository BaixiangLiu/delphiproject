...
Uses DBChart, TeeProcs, DB, TeeConst;
  ...
  begin
    ...
    case CBSort.ItemIndex of
      ...
      1: begin
           ...
           TheSeries.MandatoryValueList.Order:=TChartListOrder(1+CBSortType.ItemIndex);
         end;
      0: begin
           TheSeries.MandatoryValueList.Order:=loNone;
           TheSeries.NotMandatoryValueList.Order:=loNone;
  ...
  begin
    ...
    if CBSort.Enabled then
       ...
       begin
         ...
         begin
           CBSort.ItemIndex:=1;
           CBSortType.ItemIndex:=Ord(TheSeries.MandatoryValueList.Order)-1;
         end
       ...
       begin
         CBSort.ItemIndex:=2;
         CBSortType.ItemIndex:=Ord(tmpOrder)-1;
       end;
...
initialization
  TeeSources.Add(TDBSummarySource);
finalization
  TeeSources.Remove(TDBSummarySource);
end.
