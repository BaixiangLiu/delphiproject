...
begin
  { TeeConst }
  TeeMsg_Copyright          :='(c) 1995-2003 David Berneda';
  ...
  TeeMsg_InvalidTeeFile     :='Ogiltigt Diagram i *.tee fil';
  TeeMsg_WrongTeeFileFormat :='Fel *.TEE fil format';
...
'ABOUT TEECHART PRO V6.01=Om TeeChart Pro v6.01'#13+
