...
Var TeeSpanishLanguage:TStringList=nil;
...
begin
  { TeeConst }
  TeeMsg_Copyright          :='© 1995-2003 por David Berneda'; { 5.01 }
  ...
  TeeMsg_EnterDateTime      :='Introduzca [Nº de días] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='Gráfico no válido en archivo *.tee ';
  TeeMsg_WrongTeeFileFormat :='Formato de archivo *.tee incorrecto';
...
begin
  ...
  begin
    TeeSpanishLanguage:=TStringList.Create;
