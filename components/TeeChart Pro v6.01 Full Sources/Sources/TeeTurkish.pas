...
begin
  ...
  TeeMsg_DataSet            :='Tabla/consulta';//TeeMsg_DataSet            :='Veri Kümesi';
  TeeMsg_AskDataSet         :='&Tabla/consulta:';//TeeMsg_DataSet            :='&Veri Kümesi:';
  ...
  TeeMsg_InvalidTeeFile     :='*.tee dosyasýndaki grafik geçersiz ';
  TeeMsg_WrongTeeFileFormat :='*.tee dosya biçimi hatalý';
  TeeMsg_EmptyTeeFile       :='*.tee dosyasý boþ';  { 5.01 }
