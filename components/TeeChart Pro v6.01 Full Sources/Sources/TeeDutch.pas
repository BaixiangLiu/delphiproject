...
begin
  ...
  TeeMsg_EnterDateTime      :='Invoeren [Aantal dagen] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='Ongeldige Grafiek in *.tee file';
  TeeMsg_WrongTeeFileFormat :='Verkeerde *.tee bestandsformaat';
