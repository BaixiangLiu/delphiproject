...
Var TeeGermanLanguage:TStringList=nil;
...
begin
  ...
  TeeMsg_EnterDateTime      :='Eingabe [Anzahl der Tage] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='Ungültiger Chart in *.tee File';
  TeeMsg_WrongTeeFileFormat :='Falsches *.tee file Format';
  TeeMsg_EmptyTeeFile       :='Leerer *.tee file';  { 5.01 }
...
begin
  ...
  begin
    TeeGermanLanguage:=TStringList.Create;
