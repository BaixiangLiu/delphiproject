...
procedure TEPSCanvas.Frame3D( var Rect: TRect; TopColor, BottomColor: TColor;
                             Width: Integer);
begin
  Brush.Style:=bsClear;
  {$IFDEF D5}
...
procedure TEPSCanvas.RotateLabel3D(x,y,z:Integer; Const St:String; RotDegree:Integer);
begin
  Calc3DPos(x,y,z);
  Add('gs '+PointToStr(x,y) + ' tr ' + IntToStr(RotDegree)+ ' rot');
  TextOut(0,Self.Bounds.Bottom,St);
  Add('gr');
end;

procedure TEPSCanvas.RotateLabel(x,y:Integer; Const St:String; RotDegree:Integer);
begin
