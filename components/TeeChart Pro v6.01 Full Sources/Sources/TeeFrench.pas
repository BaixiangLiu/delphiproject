...
begin
  { TeeConst }
  TeeMsg_Copyright          :='© 1995-2003 par David Berneda';
  ...
  TeeMsg_EnterDateTime      :='Entrer [Numbre de jours] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='Graphique invalide dans le fichier *.tee';
  TeeMsg_WrongTeeFileFormat :='Mauvais format de fichier *.tee';
  TeeMsg_EmptyTeeFile       :='Fichier *.tee vide';  { 5.01 }
...
'ABOUT TEECHART PRO V6.01=A propos TeeChart Pro v6.01'#13+
