...
begin
  ...
  TeeMsg_DefaultPercentOf2  :='%s %s'+#13+'-a';
  ...
  TeeMsg_EnterDateTime      :='Felvétel [Napok száma] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='Érvényítelen karakter a *.tee fájlban';
  TeeMsg_WrongTeeFileFormat :='Rossz *.tee fájl formátum';
  TeeMsg_EmptyTeeFile       :='Üres *.tee fájl';  { 5.01 }
...
'ABOUT TEECHART PRO V6.01=TeeChart Pro v6.01'#13+
