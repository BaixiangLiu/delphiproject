...
begin
  ...
  TeeMsg_InvalidTeeFile     :='Chart Tidak Valid dalam file *.tee';
  TeeMsg_WrongTeeFileFormat :='Kesalahan format file *.tee';
  TeeMsg_EmptyTeeFile       :='Kekosongan file *.tee';  { 5.01 }
  ...
  TeeMsg_NativeFilter :='File TeeChart (*.tee)|*.tee';
...
'CLOSE=Tutup'+#13+
'OK=Terima'+#13+
'ABOUT TEECHART PRO V6.01=Tentang TeeChart Pro v6.01'+#13+
'OPTIONS=Pilihan'+#13+
'FORMAT=Format'+#13+
'TEXT=Teks'+#13+
...
'ALLOW DRAG=Pergeseran Diperbolehkan'+#13+
...
'END=Akhir'+#13+
'MIDDLE=Tengah'+#13+
'NO MIDDLE=Tidak Tengah-Tengah'+#13+
'DIRECTION=Arah'+#13+
...
'SHOW LEGEND=Tampilkan Legenda'+#13+
'SHOW MARKS=Tampilkan Penandaan'+#13+
'FINISH=Selesai'+#13+
'RANDOM=Acak'+#13+
...
'SORT=Orden'+#13+
'MARKS=Tanda'+#13+
'BEVEL INNER=Siku sebelah dalam'+#13+
'BEVEL OUTER=Siku sebelah luar'+#13+
