...
begin
  ...
  TeeMsg_EnterDateTime      :='Vnesi [Število Dni] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='Neveljaven graf v *.tee datoteki';
  TeeMsg_WrongTeeFileFormat :='Napaèen *.tee format datoteke';
  TeeMsg_EmptyTeeFile       :='Prazna *.tee datoteka';  { 5.01 }
...
'MINUTES=Minute'#13+
'SECONDS=Sekunde'#13+
'START VALUE=Zaèetna vrednost'#13+
'END VALUE=Konèna vrednost'#13+
...
'ABOUT TEECHART PRO V6.01=O TeeChart Pro v6.01'#13+
...
'CALCULATE USING=izra?unaj z uporabo'#13+
