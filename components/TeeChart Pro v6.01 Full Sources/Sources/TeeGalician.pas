...
begin
  ...
  TeeMsg_InvalidTeeFile     :='Gráfico non válido en archivo *.tee ';
  TeeMsg_WrongTeeFileFormat :='Formato do archivo *.tee incorrecto';
  TeeMsg_EmptyTeeFile       :='Archivo *.tee valeiro';  { 5.01 }
...
'NO LIMIT DRAG=Sen límites arrastre'
;
  end;
end;
