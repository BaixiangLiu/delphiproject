...
Var TeeCatalanLanguage:TStringList=nil;
...
begin
  { TeeConst }
  TeeMsg_Copyright          :='© 1995-2003 per David Berneda'; { 5.01 }
  ...
  TeeMsg_EnterDateTime      :='Introdueixi [nombre de dies] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='L''arxiu *.tee conté un gràfic no vàlid';
  TeeMsg_WrongTeeFileFormat :='El format de l''arxiu *.tee és incorrecte';
  TeeMsg_EmptyTeeFile       :='L''arxiu *.tee és buit';  { 5.01 }
...
begin
  ...
  begin
    TeeCatalanLanguage:=TStringList.Create;
...
'CLOSE=Tancar'+#13+
'OK=Aceptar'+#13+
'ABOUT TEECHART PRO V6.01=Referència de TeeChart Pro v6.01'+#13+
'OPTIONS=Opcions'+#13+
'FORMAT=Format'+#13+
'TEXT=Texte'+#13+
...
'LEGEND STYLE=Estil de Legenda'+#13+
'POINTS PER PAGE=Punts per pàgina'+#13+
'SCALE LAST PAGE=Escalar última pàgina'+#13+
'CURRENT PAGE LEGEND=Legenda amb pàgina actual'+#13+
'BACKGROUND=Fons'+#13+
...
'VALUES=Valors'+#13+
'FORMATS=Formats'+#13+
'SHOW IN LEGEND=Veure en Legenda'+#13+
'SORT=Ordre'+#13+
'MARKS=Marques'+#13+
