...
{ Copyright 1998-2003 by David Berneda.}
{**************************************}
unit ImageBar;
{$I TeeDefs.inc}
...
Uses TeeProcs, SysUtils, TeeProCo;
...
begin
  ...
  if Assigned(FImage.Graphic) then { <-- if non empty image... }
  Begin
...
initialization
  RegisterTeeSeries( TImageBarSeries, @TeeMsg_ImageBarSeries, @TeeMsg_GallerySamples, 1 );
finalization
