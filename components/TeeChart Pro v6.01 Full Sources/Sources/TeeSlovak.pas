...
'CLOSE=Zapri'#13+
'IMAGE=Slika'#13+
'TEECHART PRINT PREVIEW=TeeChart Predogled'#13+
...
'OTHER=Ostalo'#13+
'PATTERNS=Vzorci'#13+
'CLOSE CIRCLE=Zapri krog'#13+
'VISIBLE=Vidno'#13+
'CLOCKWISE=V smeri urinega kazalca'#13+
'SIZE %=Velikost %'#13+
'PATTERN=Vzorec'#13+
'DEFAULT=Privzeto'#13+
...
'USE ORIGIN=Uporabi izvor'#13+
'MULTIPLE BAR=Mnogodelen stolpec'#13+
'SIDE=Stran'#13+
'STACKED 100%=Skladoven 100%'#13+
...
'COMPUTER='#13+
'WORLD='#13+
'FOLDER OPEN AND CLOSE='#13+
'CHECKED CLOSED FOLDER='#13+
'UNCHECKED CLOSED FOLDER='#13+
'CHECKED='#13+
'UNCHECKED='#13+
'RADIO CHECKED='#13+
'RADIO UNCHECKED='#13+
'RADIO CHECKED FOLDER='#13+
'RADIO UNCHECKED FOLDER='#13+
'HORIZONTAL SIZE='#13+
'VERTICAL SIZE='#13+
'MOVE HORIZ='#13+
'MOVE VERT='#13+
