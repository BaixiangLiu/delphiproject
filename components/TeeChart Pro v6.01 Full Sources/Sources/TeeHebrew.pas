...
begin
  { TeeConst }
  TeeMsg_Copyright          :='דוד ברנדה 1995-2003 ©';
  ...
  TeeMsg_InvalidTeeFile     :='*.tee תרשים לא נכון בקובץ';
  TeeMsg_WrongTeeFileFormat :=' *.tee מבנה לא נכון של קובץ';
  TeeMsg_EmptyTeeFile       :='ריק *.teeקובץ';  { 5.01 }
...
'CLOSE=סגור'+#13+
'OK=אישור'+#13+
'ABOUT TEECHART PRO V6.01=TeeChart Pro v6.01 אודות '+#13+
'OPTIONS=אפשרויות'+#13+
'FORMAT=עיצוב'+#13+
'TEXT=טקסט'+#13+
'GRADIENT=שיפוע'+#13+
