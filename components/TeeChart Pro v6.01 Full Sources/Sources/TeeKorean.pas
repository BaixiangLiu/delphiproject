...
begin
  ...
  TeeMsg_InvalidTeeFile     :='*.tee file 안에 유효하지 않은 차트';
  TeeMsg_WrongTeeFileFormat :='잘못된 *.tee file 형식';
  TeeMsg_EmptyTeeFile       :='비어있는 *.tee file';  { 5.01 }
  ...
  TeeMsg_NativeFilter :='차트 파일 (*.tee)|*.tee';
...
'CLOSE=닫기'+#13+
'OK=확인'+#13+
'ABOUT TEECHART PRO V6.01=TeeChart Pro v6.01 에 대하여'+#13+
'OPTIONS=옵션'+#13+
'FORMAT=형식'+#13+
'TEXT=텍스트'+#13+
'GRADIENT=변화'+#13+
