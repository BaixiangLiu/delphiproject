...
begin
  { TeeConst }
  TeeMsg_Copyright          :='© 1995-2003 por David Berneda';
  ...
  TeeMsg_EnterDateTime      :='Entre [Número de Dias] [hh:mm:ss]';
  ...
  TeeMsg_InvalidTeeFile     :='Gráfico Inválido em arquivo *.tee';
  TeeMsg_WrongTeeFileFormat :='Formato de arquivo *.tee incorreto';
  TeeMsg_EmptyTeeFile       :='Arquivo *.tee vazio';  { 5.01 }
...
'ABOUT TEECHART PRO V6.01=Sobre TeeChart Pro v6.01'#13+
