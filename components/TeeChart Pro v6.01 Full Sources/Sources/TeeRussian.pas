...
begin
  { TeeConst }
  TeeMsg_Copyright          :='© 1995-2003 Давид Бернеда';
  ...
  TeeMsg_InvalidTeeFile     :='Неправильный график в *.tee файле';
  TeeMsg_WrongTeeFileFormat :='Неправильный формат *.tee файла';
  TeeMsg_EmptyTeeFile       :='Пустой *.tee файл';  { 5.01 }
